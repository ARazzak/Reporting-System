                    ...
                    <form method="POST" action="{{ URL::to('/register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 input-group">
                               <div class="input-group-prepend"><span class="input-group-text">+88</span></div>
                                <input id="phone" type="number" maxlength="11" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="mobile" value="{{ old('mobile') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="custom-select" id="inlineFormCustomSelect" name="division">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="custom-select" id="inlineFormCustomSelect" name="district">
                                    <option selected>Choose...</option>
                                    <option value="1">One</option>
                                    <option value="2">Two</option>
                                    <option value="3">Three</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="zip_code" type="nmuber" class="form-control{{ $errors->has('zip_code') ? ' is-invalid' : '' }}" name="zip_code" value="{{ old('zip_code') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="custom-select" id="inlineFormCustomSelect"  name="gender">
                                    <option selected>Choose...</option>
